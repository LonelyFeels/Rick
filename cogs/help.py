...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embedhelp.add_field(name='.unban <IGN> <USER#DISCRIMINATOR>', value='Use this to unban both from Discord and Minecraft server.', inline=False)
        embedhelp.add_field(name='.clear <amount=5>', value='Use this to clear messages.', inline=False)
        embedhelp.add_field(name='_ _', value='_ _', inline=False)
        embedhelp.add_field(name='Categories:', value='Help: Help, Donate, Invite, Dynmap; Status: Status; Roles: Accept, Reaction Roles; RCON: Whitelist, Unwhitelist, Ban, Unban, Close; Suggestions: Suggest; Clear: Clear; Fun:  Hug, 8ball, Waifu', inline=False)
