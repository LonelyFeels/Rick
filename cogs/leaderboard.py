...
class Leaderboard(commands.Cog):
    ...
    async def leaderboard(self, ctx):
        ...
        embedleaderboard.add_field(name=f'1. {discord.Client.get_user(int(data[0][0]))}', value=f'{int(data[0][1])}', inline=False)
        embedleaderboard.add_field(name=f'2. {discord.Client.get_user(int(data[1][0]))}', value=f'{int(data[1][1])}', inline=False)
